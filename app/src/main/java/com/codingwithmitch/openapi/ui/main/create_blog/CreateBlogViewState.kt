...
const val CREATE_BLOG_VIEW_STATE_BUNDLE_KEY = "com.codingwithmitch.openapi.ui.main.create_blog.CreateBlogViewState"

@Parcelize
data class CreateBlogViewState(

    // CreateBlogFragment vars
    var blogFields: NewBlogFields = NewBlogFields()) : Parcelable {
